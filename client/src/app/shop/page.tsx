      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 min-h-screen">
         <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 mb-16">
            <div>
               ...
               <p className="text-secondary/50 mt-2">Handcrafted with the finest ingredients and a passion for baking, each creation is designed to offer a truly indulgent experience — where taste, texture, and quality come together beautifully.</p>
            </div>
